...
/**
 * Simple controller implementation which extends its base class by maintaining
 * references to frame and model, and by simple demo implementations of the
 * required three abstract methods.
 * 
 * @author R. Lunde
 */
